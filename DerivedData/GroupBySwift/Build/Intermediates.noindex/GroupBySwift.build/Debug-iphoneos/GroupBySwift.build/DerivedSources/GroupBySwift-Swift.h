...
#ifndef GROUPBYSWIFT_SWIFT_H
#define GROUPBYSWIFT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GroupBySwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12GroupBySwift11AppDelegate")
...
@interface Fruits (SWIFT_EXTENSION(GroupBySwift))
@property (nonatomic, copy) NSDate * _Nullable createdAtDate;
@property (nonatomic, copy) NSString * _Nullable dateString;
@property (nonatomic, copy) NSString * _Nullable fruitColor;
@property (nonatomic, copy) NSUUID * _Nullable fruitID;
@property (nonatomic, copy) NSString * _Nullable fruitName;
@end

@class UIWindow;
@class UIScene;

SWIFT_CLASS("_TtC12GroupBySwift13SceneDelegate")
...
SWIFT_CLASS("_TtC12GroupBySwift13TableViewCell")
...
SWIFT_CLASS("_TtC12GroupBySwift14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(GroupBySwift)) <UITableViewDataSource, UITableViewDelegate>
